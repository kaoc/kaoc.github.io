...
<table id="main table" align="center" style="border:0" onLoad="resetAll()">
	...
	<table id="Onam_reg" align="left" style="border:0">
		...
		<tr style="border:0;background:transparent"><td style="border:0;background:transparent" colspan="2"> <div id="or_enb"> <font style="color:red">click here to register for Onam programs or Pookalam competition</font> </div></td></tr>
